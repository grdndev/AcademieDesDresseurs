                ...
                <div className="bg-white p-8 rounded-3xl shadow-2xl border border-gray-100">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100 space-y-4">
                        ...
                        <div className="bg-gray-50 rounded-xl p-3 text-xs text-gray-500 space-y-1">
                            ...
                            <p>• <span className="font-mono">joueur@test.fr</span> / User1234!</p>
                            <p>• <span className="font-mono">prof@academiedesdresseurs.fr</span> / Prof1234!</p>
                            <p>• <span className="font-mono">admin@academiedesdresseurs.fr</span> / Admin1234!</p>
                        </div>
                    </div>
                </div>
            </div>
